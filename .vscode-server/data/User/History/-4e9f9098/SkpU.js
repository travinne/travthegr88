...
function newRamen(event){
    ...
    const newRamen = {
        name: document.getElementById('new-image').Value,
        name: document.getElementById('new-name').Value,
        name: document.getElementById('new-restaurant').Value,
        name: document.getElementById('new-rating').Value,
        name: document.getElementById('new-comment').Value,
    }
}
