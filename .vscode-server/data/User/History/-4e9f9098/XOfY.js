...
function newRamen(event){
    ...
    const newRamen = {
        id: ramens.length + 7,
        image: document.getElementById('image-ramen').value,
        name: document.getElementById('name-ramen').value,
        restaurant: document.getElementById('restaurant-ramen').value,
        rating: document.getElementById('rating-ramen').value,
        comment: document.getElementById('comment-ramen').value,
    }
