...
//filter
//let filter_numbers = numbers.filter((numbers) => number %2==0)
//console.log(filter_numbers)

//map
//let_new_numbers_array = numbers.map(function(num){
    //return num **2
...
function names (name,callback){
    console.log(`hello there ${name}`)
    callback()
}
function name2 (){console.log ("gichimu")}
names('travinne ',name2)